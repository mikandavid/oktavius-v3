import { APP_NAV_MODULES } from '@/lib/appNavModules';

/**
 * Module ids the generator may target. Wider than the app's OrgModuleId on
 * purpose: generated modules do not exist in the manifest yet.
 */
type AppNavRouteId = string;
