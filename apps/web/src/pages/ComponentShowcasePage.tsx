...
import {
  ShowcaseGroupProvider,
  ShowcaseGroupTabs,
  ShowcaseOverview,
  ShowcaseQuickIndex,
  ShowcaseSection,
  ShowcaseSectionNav,
} from './showcase/ShowcaseChrome';
...
const showcaseFields: FormField[] = [
  ...
  {
    name: 'contactKind',
    label: 'Contact kind (radio)',
    type: 'radio',
    options: [
      { value: 'primary', label: 'Primary', description: 'Main point of contact' },
  ...
  },
  {
    ...
    placeholder: 'Add tag…',
    section: 'Additional',
    description: 'Enter tags and press Enter or comma.',
  },
  { name: 'address', label: 'Address', type: 'address', section: 'Additional', colSpan: 2 },
  {
    name: 'notes',
    label: 'Notes',
    type: 'textarea',
    section: 'Additional',
    colSpan: 2,
    description: 'Long-form text field.',
  },
  {
    name: 'terms',
    label: 'Terms',
...
const SHOWCASE_CALENDAR_EVENTS: CalendarEvent[] = [
  ...
  },
  {
    ...
    end: '2026-05-26T11:45',
    calendarId: 'personal',
  },
  {
    id: 'cal-7',
    title: 'Workshop',
    start: '2026-05-28T13:00',
    end: '2026-05-28T15:00',
    calendarId: 'clients',
  },
  {
    id: 'cal-8',
...
const SHOWCASE_APPROVALS: ApprovalItem[] = [
  {
    id: 'ap_1',
    title: 'Purchase order #PO-1042',
    requester: 'Anna Hofer',
    submittedAt: '23.05.2026 09:14',
    status: 'pending',
    amount: 4200,
    note: 'Office equipment refresh — 12 laptops.',
  },
  {
    id: 'ap_2',
    title: 'Invoice write-off INV-883',
    requester: 'Markus Leitner',
    submittedAt: '22.05.2026 16:40',
    status: 'pending',
    amount: 890,
  },
];

const SHOWCASE_TASKS: TaskInboxItem[] = [
  {
    id: 'task_1',
...
const SHOWCASE_COMMENTS: CommentItem[] = [
  {
    id: 'c1',
    author: 'Anna Hofer',
    body: 'Client confirmed delivery window for next week.',
    createdAt: '2026-05-22T10:30:00Z',
  },
  {
    id: 'c2',
    author: 'Markus Leitner',
    body: 'Finance flagged partial payment — waiting on AP.',
    createdAt: '2026-05-23T08:15:00Z',
    internal: true,
  },
];

const SHOWCASE_CATALOG: CatalogOption[] = [
  { id: 'cat_1', label: 'Net 30', code: 'NET30', active: true, sortOrder: 1 },
  { id: 'cat_2', label: 'Net 14', code: 'NET14', active: true, sortOrder: 2 },
...
const SHOWCASE_DOC_TEMPLATES = [
  {
    ...
    description: 'Logo, line items, payment terms',
    category: 'Billing',
  ...
  },
  {
    id: 'tpl_po',
    name: 'Purchase order',
    description: 'Vendor block + delivery address',
    category: 'Procurement',
    updatedAt: '08.05.2026',
  },
];

const SHOWCASE_EMAIL_TEMPLATES = [
  {
    id: 'em_1',
    name: 'Invoice sent',
    subject: 'Your invoice from Apex Technologies',
    description: 'Attached PDF, payment link',
  },
  {
    id: 'em_2',
    name: 'PO confirmation',
    subject: 'Purchase order confirmation',
    description: 'Sent to vendor contact',
  },
];
...
export function ComponentShowcasePage() {
  ...
  const [phoneVal, setPhoneVal] = useState('+43 ');
  ...
  const toggleCalendarSource = (calendarId: string, visible: boolean) => {
    setCalendarSources((current) =>
      current.map((source) => (source.id === calendarId ? { ...source, visible } : source)),
    );
  };
  ...
  return (
    <ShowcaseGroupProvider>
      <ModulePage
        ...
        subtitle="Browse by group — foundations, components, data shell, and ERP patterns."
      ...
      >
        <div className="space-y-8 pb-8">
          <InfoBox
            ...
            title="Live token editor"
          >
            Use the ⚙ panel (bottom-right) to tweak radius, shadows, accent, and fonts in real time.
          </InfoBox>

          <ShowcaseOverview />

          <div className="sticky top-0 z-20 -mx-1 space-y-3 border-b border-border/40 bg-background/95 px-1 py-3 backdrop-blur-sm">
            <ShowcaseGroupTabs />
            <ShowcaseSectionNav />
          </div>
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            <Card>
              <CardHeader>
                <CardTitle>Current token defaults</CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <p className="mt-4 text-xs text-muted-foreground border-t border-border/60 pt-3">
                  All values are CSS custom properties. The Token Editor (⚙ bottom-right) lets you
                  adjust them live.
                </p>
              </CardContent>
            </Card>
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          <ShowcaseSection
            ...
            title="Actions"
            description={
              'Buttons are the primary interaction unit. Use variant="cta" for page-header entry actions and dialog Save/Create. Full-page forms use variant="default" on submit. Use ghost for icon-only buttons (always with a Tooltip).'
            }
          >
            {/* Buttons */}
            <Card>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card>
                ...
                <CardContent>
                  <p className="mb-3 text-xs text-muted-foreground">
                    Action/kebab menus. CrudTable row actions use this internally.
                  </p>
                  <DropdownMenu>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>AlertDialog · ConfirmPopover · ConfirmActionDialog</CardTitle>
                </CardHeader>
                <CardContent>
                  <p className="mb-3 text-xs text-muted-foreground">
                    <strong>AlertDialog</strong> — blocks UI, irreversible actions.{' '}
                    <strong>ConfirmPopover</strong> — inline, lighter.{' '}
                    <strong>ConfirmActionDialog</strong> — shared destructive pattern.
                  </p>
                  <div className="flex flex-wrap gap-2">
                    <AlertDialog>
                      ...
                      <AlertDialogContent>
                        <AlertDialogHeader>
                          ...
                          <AlertDialogDescription>
                            Blocks all interaction until resolved. Use for truly irreversible
                            actions.
                          </AlertDialogDescription>
                        </AlertDialogHeader>
                        <AlertDialogFooter>
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card>
                <CardHeader>
                  <CardTitle>Input · Textarea · NumberInput</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <div className="space-y-1.5">
                    ...
                    {numberVal ? (
                      <p className="font-mono text-xs text-muted-foreground">{numberVal}</p>
                    ) : null}
                  </div>
                  <div className="space-y-1.5">
                ...
                <CardContent className="space-y-4">
                  <div className="space-y-3">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <Label htmlFor="sc-cb3" className="text-muted-foreground">
                        Disabled
                      </Label>
                    </div>
                  </div>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card>
                ...
                <CardContent className="space-y-3">
                  <div className="space-y-1.5">
                    ...
                    />
                    {comboVal ? (
                      <p className="font-mono text-xs text-muted-foreground">{comboVal}</p>
                    ) : null}
                  </div>
                  <div className="space-y-1.5">
                    ...
                    <Combobox
                      options={[
                        { value: 't1', label: 'Tag Alpha' },
                        { value: 't2', label: 'Tag Beta' },
                      ]}
                      placeholder="Search tags…"
                      onCreate={{
                        label: '+ New tag',
                        onSubmit: async (l) => {
                          toast.success(`Created: ${l}`);
                          return l;
                        },
                      }}
                      footerAction={{
              ...
              <Card>
                <CardHeader>
                  <CardTitle>MultiSelect · TagsInput</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <div className="space-y-1.5">
                  ...
                  <div className="space-y-1.5">
                    <p className="text-xs font-medium text-muted-foreground">
                      TagsInput (free-form, Enter or comma)
                    </p>
                    <TagsInput
                      value={tagsVal}
                      onChange={setTagsVal}
            ...
            <Card>
              <CardHeader>
                <CardTitle>DatePicker · DateRangePicker · FileInput</CardTitle>
              </CardHeader>
              <CardContent>
                <div className="grid gap-6 sm:grid-cols-2">
                  <div className="min-w-0 space-y-1.5">
                    ...
                    <DatePicker
                      mode="date"
                      value={dateVal}
                      onChange={(v) => setDateVal(v ?? undefined)}
                    />
                    {dateVal ? (
                      <p className="font-mono text-xs text-muted-foreground">{dateVal}</p>
                    ) : null}
                  </div>
                  <div className="min-w-0 space-y-1.5">
                    ...
                    <DatePicker
                      mode="time"
                      value={timeVal}
                      onChange={(v) => setTimeVal(v ?? undefined)}
                    />
                    {timeVal ? (
                      <p className="font-mono text-xs text-muted-foreground">{timeVal}</p>
                    ) : null}
                  </div>
                  <div className="min-w-0 space-y-1.5 sm:col-span-2">
                    <p className="text-xs font-medium text-muted-foreground">
                      DatePicker — datetime (15min step)
                    </p>
                    <DatePicker
                      mode="datetime"
                      value={datetimeVal}
                      minuteStep={15}
                      onChange={(v) => setDatetimeVal(v ?? undefined)}
                    />
                    {datetimeVal ? (
                      <p className="font-mono text-xs text-muted-foreground">{datetimeVal}</p>
                    ) : null}
                  </div>
                  <div className="min-w-0 space-y-1.5 sm:col-span-2">
                  ...
                  <div className="min-w-0 space-y-1.5 sm:col-span-2">
                    <p className="text-xs font-medium text-muted-foreground">
                      FileInput — drag & drop, emits File | null
                    </p>
                    <FileInput
                      value={fileVal}
                    ...
                    />
                    {fileVal ? (
                      <p className="text-xs text-muted-foreground">Selected: {fileVal.name}</p>
                    ) : null}
                  </div>
                </div>
              </CardContent>
            ...
            <Card>
              <CardHeader>
                <CardTitle>FormField · PhoneInput · RadioGroup · AddressField</CardTitle>
              </CardHeader>
              <CardContent className="grid gap-4 xl:grid-cols-2">
                <FormFieldControl
                  ...
                  required
                  description="Use for label, hint, and error wiring."
                  error="Example validation message"
                >
                  <Input placeholder="Control inside FormField" />
                </FormFieldControl>
                <div className="space-y-3">
                  <FormFieldControl
                    id="showcase-phone"
                    label="PhoneInput"
                    description="DACH-first dial codes + local number."
                  >
                    <PhoneInput
                      id="showcase-phone-control"
                      value={phoneVal}
                      onChange={setPhoneVal}
                    />
                  </FormFieldControl>
                  {phoneVal ? (
                    <p className="font-mono text-xs text-muted-foreground">{phoneVal}</p>
                  ) : null}
                </div>
                <FormFieldControl id="showcase-radio" label="RadioGroupField">
                  <RadioGroupField
                    id="showcase-radio-control"
                    value={radioVal}
                    options={[
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            <Card>
              ...
              <CardContent className="space-y-3">
                ...
                <p className="text-xs text-muted-foreground">
                  StatusBadge — maps string to variant automatically
                </p>
                <div className="flex flex-wrap items-center gap-2">
            ...
            <div className="grid gap-4 xl:grid-cols-3">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>StatusDot · CountBadge</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  <StatusDotLabel tone="success" value={12}>
                    Active clients
                  </StatusDotLabel>
                  <StatusDotLabel tone="warning" value={3}>
                    Expiring contracts
                  </StatusDotLabel>
                  <StatusDotLabel tone="destructive" value={1}>
                    Overdue tasks
                  </StatusDotLabel>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>MoneyText · RelativeTime · CopyButton</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-1.5">
                    ...
                    <div className="space-y-1 font-mono text-sm">
                      <div className="flex justify-between">
                        <span className="text-muted-foreground text-xs">EUR (de-AT)</span>
                        <MoneyText value={14250.5} />
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground text-xs">USD</span>
                        <MoneyText value={72000} currency="USD" locale="en-US" />
                      </div>
                      <div className="flex justify-between">
                        <span className="text-muted-foreground text-xs">Compact</span>
                        <MoneyText value={1430000} compact />
                      </div>
                      <div className="flex justify-between">
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            <Card>
              <CardHeader>
                <CardTitle>AlertBanner — full-width page-top notices</CardTitle>
              </CardHeader>
              <CardContent className="space-y-2">
                ...
                <AlertBanner tone="success">
                  Migration completed. All data is up to date.
                </AlertBanner>
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card>
                <CardHeader>
                  <CardTitle>InfoBox — inline contextual alert</CardTitle>
                </CardHeader>
                <CardContent className="space-y-3">
                  ...
                  <InfoBox
                    tone="warning"
                    icon={<WarningIcon size={18} weight="fill" />}
                    title="Warning"
                  >
                  ...
                  <InfoBox
                    tone="destructive"
                    icon={<ErrorIcon size={18} weight="fill" />}
                    title="Error"
                  >
              ...
              <Card>
                <CardHeader>
                  <CardTitle>EmptyState · Toast</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <EmptyState
                  ...
                  <div>
                    ...
                    <div className="flex flex-wrap gap-2">
                      ...
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => toast.warning('Expires in 7 days.')}
                      >
                        Warning
                      </Button>
                      <Button
                        variant="outline"
                        size="sm"
                        onClick={() => toast.info('3 items selected.')}
                      >
                        Info
                      </Button>
                      <Button
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <Card>
                <CardHeader>
                  <CardTitle>PageSkeleton — list page load state</CardTitle>
                </CardHeader>
                <CardContent>
                  <PageSkeleton />
                </CardContent>
              ...
              <Card>
                <CardHeader>
                  <CardTitle>DetailSkeleton — detail page load state</CardTitle>
                </CardHeader>
                <CardContent>
                  <DetailSkeleton />
                </CardContent>
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
              ...
              <div className="space-y-3">
                ...
                >
                  <p className="text-sm text-muted-foreground">
                    Key strategic account. Renewal due Q1. Post-mortem completed after last
                    incident.
                  </p>
                </CollapsibleSection>
                <CollapsibleSection
            ...
            <div className="space-y-3">
              <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                Tabs — complex entity workspace pages.{' '}
                <code className="font-mono font-normal">attention</code> prop shows warning dot.
              </p>
              <Tabs value={activeTab} onValueChange={setActiveTab}>
                <TabsList>
                  <TabsTrigger value="overview">Overview</TabsTrigger>
                  <TabsTrigger value="parties" attention>
                    Parties
                  </TabsTrigger>
                  ...
                  >
                    <div className="space-y-2">
                      <ListRow
                        ...
                        trailing={<Badge variant="success">Primary</Badge>}
                      />
                ...
                <TabsContent value="notes">
                  <SectionCard title="Notes">
                    <p className="text-sm text-muted-foreground">
                      Key strategic account. Renewal due Q1.
                    </p>
                  </SectionCard>
                </TabsContent>
              </Tabs>
              ...
              <div className="space-y-3">
                ...
                >
                  <SectionCard title={`Step ${wizardStep + 1} content`}>
                    <p className="text-sm text-muted-foreground">
                      Content for step {wizardStep + 1}. Replace with EntityForm or custom fields
                      per step.
                    </p>
                  </SectionCard>
                </StepperLayout>
              ...
              >
                {settingsKey === 'general' ? (
                  <SettingsSection
                    ...
                    description="Manage your organization name and locale."
                  >
                    <SettingsRow
                      label="Organization name"
                      description="Shown in reports and exports."
                    >
                      <Button variant="outline" size="sm">
                        Edit
                      </Button>
                  ...
                  <p className="text-sm text-muted-foreground">
                    Select a settings section from the nav.
                  </p>
                )}
              </SettingsLayout>
            </div>
          ...
          >
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              <EntityForm<ShowcaseFormValues>
                ...
                errors={{ email: 'Demo validation error — wire from API via EntityForm `errors`.' }}
              ...
              <div className="space-y-4">
                  ...
                  fields={[
                    {
                      key: 'id',
                      label: 'Record ID',
                      value: <span className="font-mono text-xs">dbg_001</span>,
                      section: 'Identity',
                    },
                    {
                      key: 'owner',
                      label: 'Owner',
                      value: 'Frontend extraction',
                      section: 'Identity',
                    },
                    {
                      key: 'state',
                    ...
                    },
                    {
                      key: 'theme',
                      label: 'Theme',
                      value: 'Osiris-derived border-led UI',
                      section: 'State',
                    },
                  ]}
                />
                <Card>
                  <CardHeader>
                    <CardTitle>Last Form Submit</CardTitle>
                  </CardHeader>
                  <CardContent>
                    {lastSubmit ? (
                      ...
                      <p className="text-sm text-muted-foreground">
                        Submit the sample form above to inspect values.
                      </p>
                    )}
                  </CardContent>
                </Card>
            ...
            <div className="space-y-3">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                    CrudTable — Lytenyte virtualized grid
                  </p>
                  <p className="mt-0.5 text-xs text-muted-foreground">
                    Sortable, selectable, bulk actions, typed cells (status / currency / date /
                    boolean). Drag columns to resize.
                  </p>
                </div>
                <Button
                  variant="outline"
            ...
            <Card>
              <CardHeader>
                <CardTitle>AttachmentList</CardTitle>
              </CardHeader>
              <CardContent className="grid gap-6 xl:grid-cols-2">
                <div className="space-y-2">
                  <p className="text-xs font-medium text-muted-foreground">
                    With open + delete actions
                  </p>
                  <AttachmentList
            ...
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <div className="space-y-3">
                <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                  Timeline — audit trail / activity feed
                </p>
                <Timeline
                  events={
                    [
                      {
                        ...
                        timestamp: '2024-01-15 09:41',
                        tone: 'success',
                        description: 'Anna Hofer signed contract #12.',
                      },
                      {
                        id: '2',
                      ...
                      },
                      {
                        id: '3',
                        label: 'Note added',
                        timestamp: '2024-02-03 14:22',
                        description: 'Key strategic account. Renewal due Q1.',
                      },
                      {
                        id: '4',
                        label: 'Contract renewal warning',
                        timestamp: '2024-12-20 08:00',
                        tone: 'warning',
                        description: 'Expires in 25 days.',
                      },
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            <div className="grid gap-4 xl:grid-cols-2">
              ...
              <Card>
                <CardHeader>
                  <CardTitle>Breadcrumb · InlineEdit</CardTitle>
                </CardHeader>
                <CardContent className="space-y-4">
                  <div className="space-y-2">
                    ...
                    <Breadcrumb
                      items={[
                        ...
                        { label: 'Apex Technologies', href: '/clients/cli_1001' },
                        { label: 'Contract #12' },
                      ]}
                    />
                    <Breadcrumb
                      items={[{ label: 'Settings', href: '/settings' }, { label: 'Members' }]}
                    />
                  </div>
                  <Separator />
                  <div className="space-y-2">
                    <p className="text-xs font-medium text-muted-foreground">
                      InlineEdit — click to edit in-place
                    </p>
                    <div className="space-y-1">
            ...
            <div className="grid gap-4 xl:grid-cols-3">
              <Card>
                ...
                <CardContent>
                  <p className="mb-3 text-xs text-muted-foreground">
                    MouseTooltip follows the cursor (SE offset). Wrap any element — tooltip tracks
                    the mouse.
                  </p>
                  <div className="flex flex-wrap gap-2">
                  ...
                  <MouseTooltip
                    content={
                      <div>
                        ...
                        <p className="mt-0.5 text-muted-foreground">Tooltip follows cursor</p>
                      </div>
                    }
                  >
                ...
                <CardContent>
                  <CalendarMonthPreview
                    ...
                    days={Array.from({ length: 35 }, (_, index) => {
                      const day = index - 3;
                      const date =
                        day > 0 && day <= 31 ? `2026-05-${String(day).padStart(2, '0')}` : '';
                      return {
                        date,
          ...
          >
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent>
                  <p className="mb-3 text-xs text-muted-foreground">
                    StepperLayout inside Dialog — purple Import on final step, outline Cancel
                    throughout.
                  </p>
            ...
            <div className="grid gap-4 lg:grid-cols-2">
              ...
              <Card>
                ...
                <CardContent className="space-y-3">
                  <p className="text-xs text-muted-foreground">
                    Full-page pattern when RBAC blocks a module. Route:{' '}
      ...
      ══════════════════════════════════════════════════════════════════════════ */}
          ...
          >
            ...
            <div className="space-y-2">
              ...
              <p className="text-xs text-muted-foreground">
                Complex entities lead with an Overview tab: stat row → recent activity → sub-entity
                summaries. Never put the full list on Overview — show top 3–5 with a "View all" link
                to the dedicated tab. This is shown without a Card wrapper — it lives directly
                inside a ModulePage.
              </p>
                ...
                <Timeline
                  events={
                    [
                      ...
                      {
                        id: 'e2',
                        label: 'Document uploaded: death_certificate.docx',
                        timestamp: '2024-04-02T09:30:00Z',
                        tone: 'info',
                      },
                      {
                        id: 'e3',
                        label: 'Responsible changed to Anna Hofer',
              ...
              >
                <ListRow
                  title="Anna Hofer"
                  subtitle="Primary Contact · anna@apex.at"
                  leading={<Avatar label="Anna Hofer" size="sm" />}
                />
                <ListRow
                  title="Markus Leitner"
                  subtitle="Billing Contact · markus@apex.at"
                  leading={<Avatar label="Markus Leitner" size="sm" tone="accent" />}
                />
                <ListRow
                  title="Pfarrkirche St. Stefan"
                  subtitle="Parish"
                  variant="muted"
                  leading={<Avatar label="Pfarrkirche St. Stefan" size="sm" tone="muted" />}
                />
              </SectionCard>
            </div>
            ...
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                Sub-entity Management — SectionCard + Dialog + EntityForm
              </p>
              <p className="text-xs text-muted-foreground">
                Standard pattern for managing sub-entities (parties, tasks, checklist items):
                SectionCard → ListRow per item → Dialog + EntityForm for add/edit. Never build
                  ...
                  <Dialog>
                    <DialogContent>
                      <DialogHeader>
                        ...
                        <DialogDescription>
                          Create a new task linked to this record.
                        </DialogDescription>
                      </DialogHeader>
                      <p className="text-sm text-muted-foreground">
                        EntityForm with task fields goes here.
                      </p>
                      <DialogFormFooter
                        confirmLabel="Create"
            ...
            <div className="space-y-2">
              <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                ChecklistSection — tick-off lists
              </p>
              <p className="text-xs text-muted-foreground">
                Resolution / workflow checklists on case detail (Workflow tab). Done items show
                checkbox + muted strikethrough label + faded row — not the tick alone. Use{' '}
                <code className="text-foreground">readOnly</code> on overview previews. Add items
                via <code className="text-foreground">SubEntityFormDialog</code> in modules.
              </p>
              <ChecklistSection
            ...
            {/* ERP blocks — workflow, documents, settings, reporting */}
            <div className="space-y-4">
              <p className="text-xs font-semibold uppercase tracking-[0.08em] text-muted-foreground">
                ERP blocks — workflow · documents · catalogs
              </p>
              <p className="text-xs text-muted-foreground">
                Reusable blocks for procurement approvals, task queues, document generate/send,
                catalog settings, and saved list views. Compose these inside DetailView tabs or
                module workspaces.
              </p>
              ...
              <div className="flex flex-wrap items-center gap-2">
                <SavedViewSelector
                  views={[
                    { id: 'all', label: 'All records', isDefault: true },
                    { id: 'open', label: 'Open only' },
                    { id: 'mine', label: 'Assigned to me' },
                  ]}
                  value={savedViewId}
                  onChange={setSavedViewId}
                  onSaveCurrent={() => toast.success('View saved.')}
                />
                <Button
                  type="button"
                  variant="outline"
              ...
              <div className="grid gap-4 xl:grid-cols-2">
                ...
                />
                <TaskInbox
                  items={SHOWCASE_TASKS}
                  onItemClick={() => toast.info('Open task detail.')}
                />
              </div>
                ...
                <ApprovalHistory
                  entries={[
                    ...
                    },
                    {
                      id: 'h2',
                      label: 'Comment added',
                      description: 'Please confirm budget code.',
              ...
              <ChartCard
                title="Open PO value by month"
                meta="Procurement dashboard"
                type="bar"
                data={[
                  { label: 'Jan', value: 12 },
                  { label: 'Feb', value: 18 },
              ...
              <KanbanBoard
                columns={[
                  { id: 'lead', title: 'Lead', items: [{ id: 'k1', title: 'Acme GmbH' }] },
                  {
                    id: 'qualified',
                    title: 'Qualified',
                    items: [
                      { id: 'k2', title: 'Northwind AG' },
                      { id: 'k3', title: 'Contoso KG' },
                    ],
                  },
                  { id: 'proposal', title: 'Proposal', items: [] },
                  { id: 'won', title: 'Won', items: [{ id: 'k4', title: 'Apex Retail' }] },
                ]}
                getItemId={(item) => item.id}
                renderCard={(item) => (
                  <ListRow variant="queue" title={item.title} subtitle="CRM pipeline demo" />
                )}
                emptyLabel="No deals"
        ...
        <Dialog open={dialogOpen} onOpenChange={setDialogOpen}>
          <DialogContent className="max-w-2xl">
            <DialogHeader>
              ...
              <DialogDescription>
                Dialog + EntityForm with <code className="text-xs">surface="dialog"</code> — purple
                Save, no nested card.
              </DialogDescription>
            </DialogHeader>
        ...
        <DocumentGenerateDialog
          ...
          templates={SHOWCASE_DOC_TEMPLATES}
          onGenerate={() => toast.success('Document generated.')}
        />

        <DocumentSendDialog
          open={sendDocOpen}
          onOpenChange={setSendDocOpen}
          emailTemplates={SHOWCASE_EMAIL_TEMPLATES}
          documentName="invoice_march.pdf"
          defaultRecipient="billing@client.example"
          onSend={() => toast.success('Document sent.')}
        />
