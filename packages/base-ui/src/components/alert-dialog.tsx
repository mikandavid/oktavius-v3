...
>(({ className, ...props }, ref) => (
  <AlertDialogPrimitive.Overlay
    ref={ref}
    className={cn(
      'fixed inset-0 z-50 bg-background/40 opacity-0 transition-opacity duration-75 data-[state=open]:opacity-100 data-[state=closed]:opacity-0 supports-[backdrop-filter]:backdrop-blur-[2px]',
      className,
    )}
    {...props}
  />
