...
Import catalog for `apps/web` + `@oktavius/base-ui`.

**Rules:** [`ui-system.md`](./ui-system.md) · [`patterns.md`](./patterns.md) · [`foundation.md`](./foundation.md) · [`README.md`](./README.md)

**Stack:** React 19, Tailwind v3, Lytenyte via `CrudTable`, icons from `@/lib/icons` only, Radix via base-ui.
